    ...
    <>
      ...
      {tocEnabled &&
        (tocReplace ?? (
          <div
            id="nd-toc"
            className="sticky top-(--fd-docs-row-3) [grid-area:toc] h-[calc(var(--fd-docs-height)-var(--fd-docs-row-3))] flex flex-col w-(--fd-toc-width) pt-10 pe-6 pb-4 xl:layout:[--fd-toc-width:260px] max-xl:hidden overflow-hidden"
          >
            {tocOptions.header}
            <h3
              id="toc-title"
              className="inline-flex items-center gap-2 text-xs font-semibold text-fd-muted-foreground uppercase tracking-wide mb-4"
            >
              <Text className="size-4" />
              <I18nLabel label="toc" />
            </h3>
            <TOCScrollArea className="text-xs flex-1">
