...
export function TOCScrollArea({
  ...
  return (
    <div
      ...
      className={cn(
        'relative min-h-0 flex-1 text-sm overflow-auto [scrollbar-width:thin] [scrollbar-color:hsl(var(--fd-muted-foreground)/0.3)_transparent] scrollbar-thin scrollbar-thumb-fd-muted-foreground/30 scrollbar-track-transparent hover:scrollbar-thumb-fd-muted-foreground/50',
        className,
      )}
      {...props}
    >
